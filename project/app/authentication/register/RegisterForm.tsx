...
export default function RegisterForm({ onSuccess }: Props) {
  ...
  return(
      <form onSubmit={handleSubmit} noValidate className={styles.form}>
        <input name="firstName" type="text" placeholder="Ime" onChange={handleChange} className={styles.input}/>
        <input name="lastName"type="text" placeholder="Prezime" onChange={handleChange} className={styles.input}/>
        ...
        <input name="confirmPassword" type="password" placeholder="Ponovi lozinku" onChange={handleChange} className={styles.input}/>
